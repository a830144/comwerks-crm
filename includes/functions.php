...
function _h($text){
    ...
    $help_id = md5($text);
    $argv = func_get_args();
    ?> <a href="#" data-ajax-modal='{"type":"inline","content":"#help_<?php echo $help_id;?>","buttons":"close","title":"<?php _e('Help');?>"}' class="" style="display:inline-block;"><i class="fa fa-question"></i></a>
...
function popup_link($link,$options=array()){
    ...
    if(isset($options['force']) && $options['force']){
        ...
        echo $link;
        ?>
        <a href="<?php echo $url;?>" data-ajax-modal='{"buttons":"close","title":"<?php echo ( isset($options['title']) ? htmlspecialchars($options['title']) : '' );?>"}'>(<?php _e('popup');?>)</a>
    <?php }
