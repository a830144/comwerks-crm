...
//                        print_r($line);
    ...
    public static function print_quote_task_dropdown($quote_task_id=false,$quote_task_data=array()){
        ...
        <span style="margin: 0 0 0 -23px; width: 20px; padding: 0; display: inline-block">
            <a href="#" onclick="return ucm.product.do_dropdown('<?php echo $quote_task_id;?>',this);" class="product-dropdown"><i class="fa fa-chevron-circle-down"></i></a>
    ...
    public static function print_job_task_dropdown($task_id=false,$task_data=array()){
        ...
        ?>
        <span style="margin: 0 0 0 -23px; width: 20px; padding: 0; display: inline-block">
            <a href="#" onclick="return ucm.product.do_dropdown('<?php echo $task_id;?>',this);" class="product-dropdown"><i class="fa fa-chevron-circle-down"></i></a>
