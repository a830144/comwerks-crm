...
<form action="" method="post" id="invoice_form">
    ...
    if(module_invoice::can_i('edit','Invoices')){
	    ...
	    if(class_exists('module_ticket') && module_ticket::is_plugin_enabled()) {
            ...
            if(!$linked_tickets)$linked_tickets = array(false); // so autoocomplete works. tood: move this into form.php
		    $fieldset_data['elements'][] = array(
                ...
                ?>
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" id="invoice_task_items" class="tableclass tableclass_rows tableclass_full">
                        ...
                        if(!$show_invoice_job_names){
	                        if(count($invoice['job_ids']))$show_invoice_job_names = 1;
                        }
                        ...
                        foreach($invoice_items as $invoice_item_id => $invoice_item_data){
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="invoice_invoice_item[<?php echo $invoice_item_id;?>][timer_id]" value="<?php echo htmlspecialchars($invoice_item_data['timer_id']);?>">
                                ...
                                if(class_exists('module_product',false)){
                                    ...
                                    module_product::print_invoice_task_dropdown($invoice_item_id,$invoice_item_data);
                                        ...
                                        <a href="#" onclick="if(confirm('<?php _e('Delete invoice item?');?>')){$(this).parent().find('input').val(''); $('#invoice_form')[0].submit();} return false;" class="delete" style="display:inline-block; float:right;"><i class="fa fa-trash"></i></a>
                                    </td>
                                    <?php if($show_task_dates){ ?>
                                    <td>
                                ...
                                <tr class="<?php echo $c++%2 ? 'odd':'even';?>">
                                    ...
                                    <td>
                                        ...
                                        if($show_invoice_job_names == 1 && !empty($invoice_item_data['job_id'])){
	                                        ?>
	                                        <span class="invoice_job_name">(<?php echo module_job::link_open($invoice_item_data['job_id'],true);?>)</span>
	                                        <?php
                                        }
                            ...
                            <div class="task_long_description" <?php if(module_config::c('invoice_show_long_desc',1)){ ?> style="display:block;" <?php } ?>><?php
                            ...
                            ?>
                                <tr id="invoice_payment_edit_<?php echo $invoice_payment_id;?>" style="display:none;">
                                    <td>
                                        ...
                                        <a href="#" onclick="if(confirm('<?php _e('Delete invoice payment?');?>')){$('#<?php echo $invoice_payment_id;?>invoice_paymentamount').val(''); $('#invoice_form')[0].submit();} return false;"  class="delete" style="display:inline-block;"><i class="fa fa-trash"></i></a>
                                        <?php } ?>
                                    </td><td>
