    ...
    //            print_r($invoice);exit;
        ...
        if(!$invoice || !is_array($invoice) || !isset($invoice['invoice_id']) || !$invoice['invoice_id']){
            ...
            $invoice = array(
                ...
                'date_paid' => '',
                'hourly_rate' => module_customer::c('hourly_rate',60, $customer_id), // hit up the customer module to get this setting, this way the customer can override this setting.
