...
?><tr class="task_editting task_row_<?php echo $quote_task_id;?>">
    ...
    <td>
        ...
        <a href="#" onclick="if(confirm('<?php _e('Delete Task?');?>')){$(this).parent().find('input').val('<?php echo _TASK_DELETE_KEY;?>'); $('#quote_task_form')[0].submit();} return false;" class="delete" style="display:inline-block; float:right;"><i class="fa fa-trash"></i></a>
        <?php } ?>
...
<tr class="task_editting task_row_<?php echo $quote_task_id;?>">
    ...
    <td class="edit_task_options">
        ...
        <a href="#" class="delete" style="float:right;" title="<?php _e('Cancel');?>" onclick="refresh_task_preview(<?php echo $quote_task_id;?>,false); return false;"><i class="fa fa-ban"></i></a>
        </div>
