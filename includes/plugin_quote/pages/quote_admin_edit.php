...
<form action="" method="post" id="quote_form">
    ...
    foreach($quote['taxes'] as $id=>$tax){  ?>
        <div class="dynamic_block">
            ...
            <a href="#" class="add_addit" onclick="seladd(this); ucm.quote.update_quote_tax(); return false;"><i class="fa fa-plus"></i></a>
            <a href="#" class="remove_addit" onclick="selrem(this); ucm.quote.update_quote_tax(); return false;"><i class="fa fa-minus"></i></a>
        </div>
    <?php } ?>
    </div>
    <script type="text/javascript">
