...
<?php }
           ...
           /* if(module_config::c('job_task_percentage',1) && ($percentage==1 || $task_data['hours']>0)){
            ...
            if(isset($task_data['long_description']) && $task_data['long_description'] != ''){ ?>
                ...
                <div class="task_long_description" <?php if(module_config::c('job_tasks_show_long_desc',0)){ ?> style="display:block;" <?php } ?>><?php
        ...
        <td align="center" valign="top">
            <?php if($task_data['invoiced'] && $task_data['invoice_id']){
                ...
                <a href="#" class="" title="<?php _e( $percentage == 1 ? 'Edit' : 'Complete');?>" onclick="edittask(<?php echo $task_id;?>,<?php echo ($task_data['hours']!=0?($task_data['hours']-$task_data['completed']):1);?>); return false;"><i class="fa fa-check"></i></a>
                <?php }else{ ?>
